      ...
      <div className="bg-gray-300 sm:h-screen h-full">
        ...
        <div className="bg-white text-black dark:bg-black dark:text-white rounded overflow-hidden shadow-lg p-6 w-96 text-center -mt-9">
            <div className="mb-4">
              ...
              <input onChange={withdrawalEstimate} className="shadow appearance-none border rounded w-full py-2 px-3 mb-10 leading-tight focus:outline-none focus:shadow-outline dark:text-black bg-white" id="deposit-amount" type="number" placeholder="0.00" name="deposit-amount" />
            </div>
            <div className="mb-4">
              <label className="block text-2xl font-bold mb-2" htmlFor="crypto-account">
                Crypto Account
              </label>
              <select onChange={withdrawalEstimate} className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline dark:text-black bg-white" id="crypto-account" name="crypto-account">
                  {
