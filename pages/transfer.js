        ...
        <div className="flex flex-col sm:flex-row justify-center items-stretch">
          <div className="bg-white text-black dark:bg-black dark:text-white rounded overflow-hidden shadow-lg p-6 w-96 text-center mb-6 sm:mb-0 -mt-9">
            ...
            <div className="mb-8 ">
              ...
              <input className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" id="transfer-amount" type="number" placeholder="0.00" ref={amountRef} />
            </div>
            <br></br>
            <br></br>
            ...
            <div className="mb-12">
              ...
              <select className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" id="crypto-account" name="crypto-account" ref={srcAccountRef}>
                {
          ...
          <div className="flex flex-col justify-center items-center sm:pr-10 sm:pl-10 mb-6 sm:mb-0">
            <Image src="/arrows.png" alt="Transfer" width="50" height="50" className="mb-4 w-12 h-12" />
            ...
            <h1 className="text-center text-2xl font-bold pb-4">Recipient Account</h1>
            {
              ...
              !accountLookup ?
                <div className="mb-8">
                  ...
                  <input className="mb-5 shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" id="account-number" type="text" placeholder="Account Number" ref={destAccountRef} />
                ...
                <div className="mb-8">
                  ...
                  <input className="mb-5 shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" id="user" type="text" placeholder="Username" ref={destAccountUserRef} />
