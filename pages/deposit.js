      ...
      <div className="bg-gray-300 dark:bg-neutral-900 sm:h-screen h-full">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-stretch">
          ...
          <div className="flex flex-col justify-center items-center sm:pr-10 sm:pl-10 mb-6 sm:mb-0">
            <Image src="/arrows.png" alt="Deposit" width="50" height="50" className="mb-4 w-12 h-12" />
          ...
          <div className="bg-white text-black dark:bg-black dark:text-white rounded overflow-hidden shadow-lg p-6 w-96 text-center -mt-9">
            <div className="mb-4">
              ...
              <input onChange={depositEstimate} className="shadow appearance-none border rounded w-full py-2 px-3 mb-10 leading-tight focus:outline-none focus:shadow-outline" id="deposit-amount" type="number" placeholder="0.00" name="deposit-amount" ref={depositAmountRef} />
            </div>
            <div className="mb-4">
              <label className="block text-2xl font-bold mb-2" htmlFor="crypto-account">
                Crypto Account
              </label>
              <select onChange={depositEstimate} className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" id="crypto-account" name="crypto-account" ref={cryptoAccountRef}>
                {
